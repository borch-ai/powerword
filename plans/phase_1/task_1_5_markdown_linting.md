...
- **Formatting and Linting Tools Configured**:
  - A Go-native markdown linter implemented under [linter.go](file://../../internal/linter/linter.go) and unit-tested in [linter_test.go](file://../../internal/linter/linter_test.go).
  - A plan template validator implemented under [linter.go](file://../../internal/linter/linter.go).
  - Multi-file scripts runner organized under [main.go](file://../../scripts/lint_markdown/main.go) and [main.go](file://../../scripts/lint_plans/main.go).
