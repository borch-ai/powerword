...
#### [NEW] [cmd/pw-mcp-coverage/main.go](file:///Users/human/code/powerword/cmd/pw-mcp-coverage/main.go)
- Create the standard CLI wrapper to initialize and run the stdio-based MCP server.

#### [NEW] [server.go](file:///Users/human/code/powerword/internal/mcp/coverage/server.go)
