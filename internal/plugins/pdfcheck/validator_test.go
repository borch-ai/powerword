...
func TestCheckInkDensity(t *testing.T) {
	...
	t.Run("gs success but no output files", func(t *testing.T) {
		...
		if len(res.Warnings) != 1 || !strings.Contains(res.Warnings[0], "No page images were generated by Ghostscript") {
			t.Errorf("expected warning about no page images, got: %v", res.Warnings)
		}
	})
