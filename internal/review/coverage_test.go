...
func TestCleanCoverageFile(t *testing.T) {
	...
	content := "mode: set\n" +
		...
		"\x00\x00\n" +
		"invalid line format\n" +
		"github.com/borch-ai/powerword/pkg/linter/validator.go:81.1,82.2 1 0\n"
...
func TestParseCoveragePercent(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			output: "github.com/borch-ai/powerword/pkg/linter/validator.go:37:\tValidatePlans\t100.0%\n" +
		...
		},
		{
			...
			output: "github.com/borch-ai/powerword/pkg/linter/validator.go:37: ValidatePlans 50.0%\n" +
