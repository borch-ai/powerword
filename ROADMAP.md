...
*   [x] **Task 6.14: Publish Automated Binary Releases of MCP Plugins**
    *   Extend the release CI workflow to dynamically discover, cross-compile, and attach all native pure-Go MCP plugin binaries (`pw-mcp-*`, excluding CGO-dependent `pw-mcp-db`) along with the core `powerword` binary to GitHub Releases.
